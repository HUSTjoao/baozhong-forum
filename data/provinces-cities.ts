// 中国所有省份、自治区、直辖市、特别行政区及其主要城市数据
export interface ProvinceData {
  name: string
  cities: string[]
}

export const ALL_PROVINCES_CITIES: ProvinceData[] = [
  {
    name: '北京市',
    cities: ['北京市']
  },
  ...
  {
    name: '西藏自治区',
    cities: ['拉萨市', '昌都市', '山南市', '日喀则市', '那曲市', '阿里地区', '林芝市']
  },
  {
    name: '陕西省',
  ...
  {
    name: '台湾省',
    cities: ['台北市', '新北市', '桃园市', '台中市', '台南市', '高雄市', '基隆市', '新竹市', '嘉义市', '新竹县', '苗栗县', '彰化县', '南投县', '云林县', '嘉义县', '屏东县', '宜兰县', '花莲县', '台东县', '澎湖县', '金门县', '连江县']
  }
]

// 获取所有省份名称
export function getAllProvinces(): string[] {
  return ALL_PROVINCES_CITIES.map(p => p.name)
}

// 根据省份获取所有城市
export function getCitiesByProvince(province: string): string[] {
  const provinceData = ALL_PROVINCES_CITIES.find(p => p.name === province)
  return provinceData ? provinceData.cities : []
}

// 获取所有城市（不分组）
export function getAllCities(): string[] {
  return ALL_PROVINCES_CITIES.flatMap(p => p.cities)
}
